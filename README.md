...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aixgent-text2image
```

A live public deployment of this template is available at [https://aixgent-text2image.templates.workers.dev](https://aixgent-text2image.templates.workers.dev)
